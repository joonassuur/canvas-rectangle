...
var rectangleDrawingApp = function rectangleDrawingApp(canvasContainer, clearCanvasButton) {
  var canvas = document.querySelector("".concat(canvasContainer, " canvas"));
  canvas.height = document.querySelector("".concat(canvasContainer, " img")).clientHeight;
  canvas.width = document.querySelector("".concat(canvasContainer, " img")).clientWidth;
  var rect = canvas.getBoundingClientRect();
  var clearCanvasBtn = document.querySelector(clearCanvasButton);
  ...
  var drawRectangle = function drawRectangle(startX, startY, rectWidth, rectHeight) {
    ctx.strokeStyle = '#000';
    ctx.fillStyle = '#000';
    ctx.font = '14px Arial';
    ctx.lineWidth = 5;
    ctx.beginPath(); // text to indicate coordinates of rectangles in relation to canvas
    // ctx.fillText(
  ...
  var calculateCoordinates = function calculateCoordinates(mouseX, mouseY) {
    ...
    if (isMouseDown) {
      ...
      if (rectangles.length > 0) {
        rectangles.forEach(function (_ref) {
  ...
  canvas.addEventListener('mousemove', function (event) {
    var mouseX = event.offsetX - rect.left;
    var mouseY = event.offsetY - rect.top;
